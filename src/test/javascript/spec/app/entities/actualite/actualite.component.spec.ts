...
import { ActualiteComponent } from 'app/entities/actualite/actualite.component';
...
describe('Component Tests', () => {
  describe('Actualite Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.actualites && comp.actualites[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
